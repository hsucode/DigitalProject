...
REM IF EXIST "C:\Program Files\Dassault Systemes\B27" set CAT_CODE=C:\Program Files\Dassault Systemes\B27
REM IF EXIST "%~dp0\GTR4" set CAT_CODE=%~dp0\GTR4

set CAT_CODE=%~dp0\GTR4

set CATPath1=%CAT_CODE%
set CATPath2=%~dp0\GTR5
set CATPath3=
set CATPath4=
set CATPath5=
set CATPath6=
...
REM Start of CATIA
REM ============================================================================================
"%CAT_CODE%\win_b64\code\bin\CATSTART.exe" -run "DigitalProject.exe" -env Env7_1 -direnv %~dp0\CATEnv -nowindow
